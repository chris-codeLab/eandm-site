    ...
    <Layout noHeaderBg pageName={"About"}>
      <div>
        <section
          ...
          style={{ backgroundImage: "url(assets/img/banner_AboutEandM.jpg)" }}
        >
            ...
            <div className="row">
              <div className="col-xl-7">
                <div className="heading">
                  ...
                  <img alt="dots" className="dots hoverstyle" src="assets/img/about_us2.jpg" />
                </div>
              </div>
              <div className="col-xl-5">
                <div className="signature">
                  <p>
                  EandM, founded in 1955, is the west coast's leader in automation. <br />
                  <br />
                  We represent the best automation companies in the world and when you buy from EandM you get the best support in the world. <br />
                  <br />
                  Training classes, workshops, tech support team are all located on the west coast—nothing is offshored. <br /> 
                  <br />
                  No waiting, no voice mail, no communication confusion—accurate answers now is our commitment to you.<br />
                    <br />
                   {" "}
                  </p>
                  <div className="ceo">
                    <div>
                      ...
                      <span>EandM Team</span>
                    </div>
                    <a href="team" className="themebtu">
                      Learn More
                    </a>
                  </div>
                </div>
        ...
        <div className="hoverstyle">
          <figure>
            <img alt="img" className="w-100" src="assets/img/1920x650-banner.jpeg" style={{overflow: "hidden", maxHeight: "450px"}}/>
          </figure>
        </div>
        <section
            ...
            <div className="row">
              <div className="col-xl-4 col-lg-6">
                <div className="makes-us-different-text">
                  ...
                  <h4>Automation Performace</h4>
                  <p>
                    Our Automation performance & innovation help to eliminate performance 
                    bottlenecks to ensure your software and hardware are working at their best.
                  </p>
                </div>
              </div>
              <div className="col-xl-4 col-lg-6">
                <div className="makes-us-different-text">
                  ...
                  <h4>Robotic Applications &amp; Ideas</h4>
                  <p>
                      Jumpstart you robot applications with these modular, simple to program 
                      collaborative robots and easy-to-assembly accessories from Top-Rated Manufacturers.
                  </p>
                </div>
              </div>
              <div className="col-xl-4 col-lg-6">
                <div className="makes-us-different-text">
                  <i>
                    <svg
                      ...
                      style={{ enableBackground: "new 0 0 60.07 60.07" }}
                      xmlSpace="preserve"
                    >
                      <path
              ...
              C45.536,53.38,44.077,54.266,42.56,55.029z"
                  ...
                  <h4>Machine Building</h4>
                  <p>
                  EandM has been helping Machine Builders for decades with products and services 
                  - like the ones listed below - that are perfect for your needs
                  </p>
                </div>
              </div>
              <div className="col-xl-4 col-lg-6">
                <div className="makes-us-different-text">
                  ...
                  <h4>Leader in Municipal Solutions</h4>
                  <p>
                  It has always been our priority and goals 
                  recognize and support the challenges faced today by water 
                  and waste water professionals.
                  </p>
                </div>
              </div>
              <div className="col-xl-4 col-lg-6">
                <div className="makes-us-different-text">
                  ...
                  <h4>Food &amp; Beverage Automations</h4>
                  <p>
                    We offer the perfect solution (with an IP69K rating) 
                    to all of your automated food and beverage processing needs.
                  </p>
                </div>
              </div>
              <div className="col-xl-4 col-lg-6">
                <div className="makes-us-different-text">
                  ...
                  <h4>Certified Safety Solutions</h4>
                  <p>
                  SICK Sensor Intelligence offers a diverse set of products and systems for 
                  fulfilling safety requirements in compliance with regulations.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-xl-4">
                <div className="heading">
                  ...
                  <p>
                    Don't take our word for it. Here's what our clients have to
                    say...
                  </p>
                </div>
              </div>
                  ...
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <div className="client-review">
                        ...
                        <a href="#">
                          <h4>A multi-disciplinary team of automation experts ...</h4>
                        </a>
                        <p>
                          " They were absolutely amazing at helping me solve my complex automation use case in
                          a cost-effective and professional manner.“
                        </p>
                        <span>Milly Carson (General Motors)</span>
                      </div>
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <div className="client-review">
                        ...
                        <p>
                          "Top Notch Customer Success Team!  Helped us every step of the way during
                          our entire build and long after.  Just Great!”
                        </p>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="client-review">
                        <i className="fa-solid fa-quote-left" />
                        <a href="#">
                          <h4>Superior Training & Support </h4>
                        </a>
                        <p>
                          " Access to tons of free tutorials and online resources as 
                          well as best in class in person learning classes! “
                        </p>
